...
// =========================================================================
// READ-ONLY VIEW - SHOW ALL AVAILABLE DATA
// =========================================================================
    ...
    <div className="trade-full-view">
      ...
      <section className="stage-section">
        ...
        <div className="grid-2">
          ...
          <div><strong>Emotional Intensity:</strong> {formatValue(trade.emotional_intensity)}/10</div>
          <div><strong>Trend Aligned:</strong> {trade.trend_aligned ? '✓ Yes' : 'No'}</div>
          <div><strong>Setup Valid:</strong> {trade.setup_valid ? '✓ Yes' : 'No'}</div>
          <div><strong>Risk OK:</strong> {trade.risk_ok ? '✓ Yes' : 'No'}</div>
          <div><strong>Checklist Passed:</strong> {trade.pre_trade_checklist_passed ? '✓ Yes' : 'No'}</div>
        </div>
      </section>
      ...
      <section className="stage-section">
        ...
        <div className="grid-2">
          ...
          <div><strong>Trade Time:</strong> {formatValue(trade.trade_time)}</div>
          ...
          <div><strong>Commissions:</strong> ${formatValue(trade.commissions || 0)}</div>
          <div><strong>Fees:</strong> ${formatValue(trade.fees || 0)}</div>
          <div><strong>P&L:</strong> <span style={{color: (trade.pnl || 0) >= 0 ? '#00d082' : '#ff6b6b', fontWeight: 600}}>${formatValue(trade.pnl || 0)}</span></div>
        </div>
      </section>
      ...
      <section className="stage-section">
        ...
        <div className="grid-2">
          ...
          <div><strong>Discipline Score:</strong> {formatValue(trade.discipline_score)}/10</div>
          <div><strong>Result:</strong> {formatValue(trade.result)}</div>
        </div>
        <div className="notes-section">
          <strong>Trade Notes:</strong>
          <p>{formatValue(trade.notes)}</p>
        </div>
        <div className="notes-section">
